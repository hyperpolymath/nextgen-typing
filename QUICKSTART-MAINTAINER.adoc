...
// Replace rsr-template-repo, nextgen-typing, {{DEPS}} with actuals
...
| `$PREFIX/share/nextgen-typing/`
| Data files, assets

| `$PREFIX/share/doc/nextgen-typing/`
| Documentation
...
Default config location: `$XDG_CONFIG_HOME/nextgen-typing/config.toml`

Fallback: `$HOME/.config/nextgen-typing/config.toml`
...
Or via OPSM: `opsm update nextgen-typing`
...
[source,bash]
----
just install --prefix=/opt/nextgen-typing-instance1 --config=/etc/nextgen-typing/instance1.toml
just install --prefix=/opt/nextgen-typing-instance2 --config=/etc/nextgen-typing/instance2.toml
----
